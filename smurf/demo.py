...
Run with a directory of images using 

 python demo.py --data_dir=img_dir --plot_dir=result_dir --checkpoint_dir=dir
...
def main(unused_argv):
  ...
  for i, (image1, image2) in enumerate(get_image_iterator()):
    ...
    smurf_plotting.save_flo_img(plot_dir=FLAGS.plot_dir, index=i,
                                       image1=image1, 
